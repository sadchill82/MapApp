...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        startButton.setTitle(NSLocalizedString("start_button", comment: "Start button text"), for: .normal)
        ...
        geocoder.geocodeAddressString(NSLocalizedString("destination_city", comment: "Destination city name")) { [weak self] placemarks, error in
